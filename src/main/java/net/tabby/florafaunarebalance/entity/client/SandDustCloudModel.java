...
public class SandDustCloudModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() { //# TODO: when updating model, only replace this part>...
		...
		PartDefinition bone2 = main.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(128, 0).addBox(-12.0F, -62.0F, 8.0F, 32.0F, 36.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 7.0F));

		PartDefinition sub = dust.addOrReplaceChild("sub", CubeListBuilder.create(), PartPose.offset(0.0F, -26.0F, -7.0F));

		PartDefinition bone3 = sub.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 103).addBox(-1.0F, -50.0F, -26.0F, 25.0F, 25.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 7.0F));

		PartDefinition bone4 = sub.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(97, 80).addBox(-25.0F, -57.0F, -8.0F, 32.0F, 23.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 7.0F));

		PartDefinition bone5 = sub.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(69, 126).addBox(-3.0F, -69.0F, -4.0F, 15.0F, 23.0F, 31.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 7.0F));

		PartDefinition bone6 = sub.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(0, 64).addBox(-7.0F, -36.0F, -19.0F, 35.0F, 14.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 7.0F));
