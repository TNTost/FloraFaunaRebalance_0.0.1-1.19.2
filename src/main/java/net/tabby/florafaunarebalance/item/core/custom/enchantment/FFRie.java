package net.tabby.florafaunarebalance.item.core.custom.enchantment;
...
import net.tabby.florafaunarebalance.item.core.custom.enchantment.custom.BarrageEnchantment;
