        ...
        tag(BlockTags.MINEABLE_WITH_AXE)
                ...
                .add(FFRib.BAMBOO_MOSAIC.get())
                        ...
                        .add(FFRib.STRIPPED_BAMBOO_WOOD.get())
                                ...
                                .add(FFRib.BUDDING_OAK_WOOD.get())
                                .add(FFRib.BUDDING_BIRCH_LOG.get())
                                .add(FFRib.BUDDING_BIRCH_WOOD.get())
                                .add(FFRib.BUDDING_SPRUCE_LOG.get())
                                .add(FFRib.BUDDING_SPRUCE_WOOD.get())
                                .add(FFRib.BUDDING_JUNGLE_LOG.get())
                                .add(FFRib.BUDDING_JUNGLE_WOOD.get())
                                .add(FFRib.BUDDING_ACACIA_LOG.get())
                                .add(FFRib.BUDDING_ACACIA_WOOD.get())
                                .add(FFRib.BUDDING_DARK_OAK_LOG.get())
                                .add(FFRib.BUDDING_DARK_OAK_WOOD.get())
                                .add(FFRib.BUDDING_MANGROVE_LOG.get())
                                .add(FFRib.BUDDING_MANGROVE_WOOD.get());
